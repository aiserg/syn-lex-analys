...
(function() {
  var ConvRes, Convol, Input, InputMassive, Keywords, Literals, Output, Separators, deleteConvRes, deleteConvol, deleteTurn, doBrackets, doMath, doPriority, errorMessage, isKeyword, isLiteral, isNumber, isSeparator, lex, lexicalAnalysis, streamWords, syn, syntaxAnalys, turn,
            ...
            if (Convol[4][0] === 0) {
              for (j = 0, len = Literals.length; j < len; j++) {
                ...
                if (word[0] === Literals[Convol[2][1]][0] && Literals[Convol[2][1]][5] !== false) {
                  if (Literals[Convol[2][1]][5] === "MATRIX") {
                  ...
                  if (Literals[Convol[2][1]][5] === "COLVECTOR") {
                    Output.value += Literals[Convol[2][1]][1] + "\n";
                    Output.value += Literals[Convol[2][1]][2] + "\n" + "\n";
                    deleteConvol();
                  }
                  if (Literals[Convol[2][1]][5] === "ROWVECTOR") {
                    Output.value += Literals[Convol[2][1]][1] + " ";
                    Output.value += Literals[Convol[2][1]][2] + "\n" + "\n";
                    deleteConvol();
                  }
                  ...
                  if (Convol[5][0] === 2 && Convol[5][1] === 2) {
                    if (Convol[6][0] === 0) {
                      if (Convol[2][1] === '1' && Convol[4][1] === '1') {
                        Output.value += Literals[Convol[0][1]][1] + "\n" + "\n";
                      }
                      if (Convol[2][1] === '1' && Convol[4][1] === '2') {
                        Output.value += Literals[Convol[0][1]][2] + "\n" + "\n";
                      }
                      if (Convol[2][1] === '2' && Convol[4][1] === '1') {
                        Output.value += Literals[Convol[0][1]][3] + "\n" + "\n";
                      }
                      if (Convol[2][1] === '2' && Convol[4][1] === '2') {
                        Output.value += Literals[Convol[0][1]][4] + "\n" + "\n";
                      }
                      deleteConvol();
                    }
                  } else {
  ...
  doMath = function() {
    var A, first_num, first_type, i, index, j, k, l, len, len1, m, n, o, p, q, r, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, second_num, second_type, temp_m, word;
    for (index = j = 0, len = turn.length; j < len; index = ++j) {
      ...
      if (Convol[word][1] === 6) {
        ...
        if (first_type === "MATRIX" && second_type === "ROWVECTOR" || first_type === "MATRIX" && second_type === "COLVECTOR") {
          errorMessage(syn, n);
        }
        if (first_type === "ROWVECTOR" && second_type === "MATRIX" || first_type === "COLVECTOR" && second_type === "MATRIX") {
          errorMessage(syn, n);
        }
      }
      if (Convol[word][1] === 4) {
        ...
        if (first_type === "MATRIX" && second_type === "COLVECTOR" || first_type === "MATRIX" && second_type === "ROWVECTOR") {
          errorMessage(syn, n);
        }
        if (first_type === "COLVECTOR" && second_type === "MATRIX" || first_type === "ROWVECTOR" && second_type === "MATRIX") {
          errorMessage(syn, n);
        }
        if (first_type === "Number" && second_type === "COLVECTOR" || first_type === "Number" && second_type === "ROWVECTOR") {
          errorMessage(syn, n);
        }
        if (first_type === "COLVECTOR" && second_type === "Number" || first_type === "ROWVECTOR" && second_type === "Number") {
          errorMessage(syn, n);
        }
      }
      if (Convol[word][1] === 5) {
    ...
    for (i = r = 0, len1 = Convol.length; r < len1; i = ++r) {
      word = Convol[i];
      if (!(Convol[i][2] === false || Convol[i][2] === 'use' || Convol[i][2] === void 0)) {
        if (Literals[Convol[0][1]][5] === "ROWVECTOR") {
          if (Convol[i][2][5] === "ROWVECTOR") {
        ...
        if (Literals[Convol[0][1]][5] === "COLVECTOR") {
          if (Convol[i][2][5] === "COLVECTOR") {
            Literals[Convol[0][1]][1] = Convol[i][2][1];
            Literals[Convol[0][1]][2] = Convol[i][2][2];
          } else {
            errorMessage('type', n);
        ...
        if (Literals[Convol[0][1]][5] === "MATRIX") {
          if (Convol[i][2][5] === "MATRIX") {
            Literals[Convol[0][1]][1] = Convol[i][2][1];
            Literals[Convol[0][1]][2] = Convol[i][2][2];
  ...
  errorMessage = function(type_err, num_str) {
    if (type_err === lex) {
    ...
    if (type_err === 'type') {
      return Output.value += "Type error in " + num_str + " string!\n\n";
    }
  };
